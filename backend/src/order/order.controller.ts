...
export class OrderController {
  ...
  public async createOrder(@Body() dto: CreateOrderDto): Promise<OrderDto> {
  ...
  public async getOrder(
    ...
    const foundOrder = await this.orderService.findOrderById(orderId);
  ...
  public async updateOrder(
    ...
    const updatedOrder = await this.orderService.updateOrderById(orderId, dto);
